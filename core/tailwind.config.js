  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // ---------------------------------------------------------------------
        // Platinum Micro brand palette
        // Drives utility classes like `bg-pm-navy-deep`, `text-pm-terracotta`.
        // Pulls from the CSS variables defined in core/globals.css.
        // ---------------------------------------------------------------------
        pm: {
          'navy-deepest':    'var(--pm-navy-deepest)',
          'navy-deep':       'var(--pm-navy-deep)',
          'navy-mid':        'var(--pm-navy-mid)',
          'navy-light':      'var(--pm-navy-light)',
          'navy-pale':       'var(--pm-navy-pale)',
          terracotta:        'var(--pm-terracotta)',
          'terracotta-light':'var(--pm-terracotta-light)',
          'terracotta-pale': 'var(--pm-terracotta-pale)',
          tan:               'var(--pm-tan)',
          'tan-pale':        'var(--pm-tan-pale)',
          paper:             'var(--pm-paper)',
          white:             'var(--pm-white)',
          'ink-100':         'var(--pm-ink-100)',
          'ink-200':         'var(--pm-ink-200)',
          'ink-300':         'var(--pm-ink-300)',
          'ink-400':         'var(--pm-ink-400)',
          'ink-500':         'var(--pm-ink-500)',
          'ink-600':         'var(--pm-ink-600)',
          'ink-700':         'var(--pm-ink-700)',
          'ink-800':         'var(--pm-ink-800)',
          'ink-900':         'var(--pm-ink-900)',
          success:           'var(--pm-success)',
          'success-bg':      'var(--pm-success-bg)',
          warning:           'var(--pm-warning)',
          'warning-bg':      'var(--pm-warning-bg)',
          danger:            'var(--pm-danger)',
          'danger-bg':       'var(--pm-danger-bg)',
        },
      },
      maxWidth: {
        'pm-container': 'var(--pm-container)',
      },
      transitionTimingFunction: {
        'pm-standard': 'var(--pm-ease-standard)',
        'pm-emphasized': 'var(--pm-ease-emphasized)',
      },
      transitionDuration: {
        'pm-fast': 'var(--pm-dur-fast)',
        'pm-base': 'var(--pm-dur-base)',
        'pm-slow': 'var(--pm-dur-slow)',
      },
      fontFamily: {
        heading: [
